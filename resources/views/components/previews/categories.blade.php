<!-- Preview Drawer -->
<div id="drawer-read-category-{{ $id }}-advanced"
    ...
    <div class="mb-4">
        ...
        <button type="button" data-drawer-dismiss="drawer-read-category-{{ $id }}-advanced"
            aria-controls="drawer-read-category-{{ $id }}-advanced"
