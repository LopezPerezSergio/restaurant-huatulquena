        ...
        <div id="filterDropdown"
            ...
            <div class="flex items-center justify-between pt-2">
                ...
                <div class="flex items-center space-x-3">
                    <button type="button"
                        class="flex items-center text-sm font-medium text-primary-600 dark:text-primary-500 hover:underline">Limpiar
                        Filtros
                    </button>
                </div>
            </div>
                ...
                <div id="roles-body" class="hidden" aria-labelledby="roles-heading">
                    <div class="py-2 font-light border-b border-gray-200 dark:border-gray-600">
                        <ul class="space-y-2">
                            ...
                            @endforeach
                            <button type="button"
                                class="flex items-center text-sm font-medium text-primary-600 dark:text-primary-500 hover:underline">Ver
                                Todo
                            </button>
                        </ul>
                    </div>
