                            ...
                            <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="flex items-center space-x-4">
                                        <button type="button" data-drawer-target="drawer-update-user-{{ $user['id'] }}"
                                            data-drawer-show="drawer-update-user-{{ $user['id'] }}"
                                            aria-controls="drawer-update-user-{{ $user['id'] }}"
                                        ...
                                        <button type="button"
                                            data-drawer-target="drawer-read-user-{{ $user['id'] }}-advanced"
                                            data-drawer-show="drawer-read-user-{{ $user['id'] }}-advanced"
                                            aria-controls="drawer-read-user-{{ $user['id'] }}-advanced"
     ...
     {{--<div id="dropdown-filters"
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                        ...
                        @foreach ($categories as $category)
                            <li class="flex items-center">
                                <button type="button" wire:click="$set('filter_category', '{{ $category['nombre'] }}')" class="w-full flex items-center p-2
                                    {{ $filter_category == $category['nombre'] ? 'bg-gray-100 dark:bg-gray-700 text-gray-900  dark:text-white hover:bg-gray-200 dark:hover:bg-gray-800' : 'text-gray-900  dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700' }}">
        ...
        <div class="py-1">
            <button type="button" wire:click="clear"
                class="w-full block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">                    <span class="ml-3">Eliminar filtros</span>
                </button>
        </div>
        </div>--}}
