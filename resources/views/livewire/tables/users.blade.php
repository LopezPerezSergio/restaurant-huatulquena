                ...
                <div class="w-full md:w-1/2">
                    <div class="flex items-center">
                        ...
                        <div class="relative w-full">
                            ...
                            <input wire:model='search' type="text" id="simple-search" placeholder="Buscar Usuario..."
                                required=""
                            ...
                            <tr class="border-b dark:border-gray-600 hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <th scope="row"
                                    ...
                                    <div class="flex items-center mr-3">
                                        <svg class="w-8 h-8 mr-1 text-gray-500 dark:text-gray-400" fill="currentColor" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg"
                                            aria-hidden="true">
                                            <path clip-rule="evenodd" fill-rule="evenodd"
                                ...
                                <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <div class="flex items-center space-x-4">
                                        <button type="button"
                                            data-drawer-target="drawer-update-user-{{ $user['id'] }}"
