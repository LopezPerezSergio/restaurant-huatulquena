                        ...
                        <fieldset>
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <button type="button"
                                    ...
                                    <svg fill="currentColor" class="h-4 w-4 mr-2 -ml-0.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                        aria-hidden="true">
                                        <path
                                                ...
                                                @forelse (Cart::content() as $product)
                                                    <tr
                                                        ...
                                                        <th scope="row" class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                            <div class="flex items-center mr-3">
                                                                <img src="{{ Storage::url($product->options->image) }}" alt="iMac Front Image" class="h-10 w-auto mr-3">
                                                                {{ $product->name }}
                                                            </div>
                                                        </th>
                                                        <td class="px-4 py-3">
