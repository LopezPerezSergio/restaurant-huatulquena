                        ...
                        <div class="p-4">
                            ...
                            <label
                                ...
                                <div class="flex">
                                    ...
                                    <input type="radio" name="size-choice" value="{{ $employee['id'] }}" disabled
                                        class="sr-only" aria-labelledby="size-choice-{{ $employee['id'] }}-label">
                                    <span class="mr-2"
                        ...
                        <div class="col-span-2 p-4">
                            ...
                            <div class="m-4">
                                <label for="codigo"
                                    ...
                                    de acceso</label>
                                <input wire:model='codigo_acceso' @if (!$employee_id) disabled readonly @endif
                                ...
                                <ul class="overflow-y-auto text-sm font-medium text-center text-gray-500 divide-x divide-gray-200  sm:flex dark:divide-gray-600 dark:text-gray-400"
                                    ...
                                    <li class="w-full">
                                        <button id="{{ $category['nombre'] }}-tab"
                                            data-tabs-target="#{{ $category['nombre'] }}" type="button" role="tab"
                                            aria-controls="stats"
                                            ...
                                            <ul role="list" class="divide-y divide-gray-200 dark:divide-gray-700">
                                                ...
                                                <li class="py-2">
                                                    <div class="flex items-center space-x-4">
                                                        ...
                                                        <button
                                                            wire:click="decItem('{{ $product['id'] }}', '{{ $product['nombre'] }}','{{ $product['precio'] }}','{{ $product['tamanio'] }}','{{ $product['categoriaName'] }}, $product->rowId')"
                                                            type="button"
                                                            class="focus:ring-4 focus:outline-none font-medium rounded-lg text-sm p-2 m-2 text-center inline-flex items-center @if ($stock > 0) text-white focus:ring-blue-300  bg-blue-700 hover:bg-blue-800 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 @else border border-b dark:text-white @endif">
                                ...
                                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                    ...
                                    <tbody>
                                        ...
                                        <tr
                                            ...
                                            <td>
                                                <button wire:click="removeItem('{{ $product->rowId }}')" type="button"
                                                    class="flex items-center text-red-700 hover:text-white border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-2 text-center dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900">
                            ...
                            <button wire:click="$set('table', 'Mesa {{ $table['nombre'] }}')" type="button"
                                ...
                                <figure
                                    ...
                                    <img class="rounded-lg h-28 w-28 mx-auto"
                                        src="https://cdn-icons-png.flaticon.com/512/6724/6724239.png" alt="rol">
                                </figure>
                            </button>
                        </div>
                        @endforeach
